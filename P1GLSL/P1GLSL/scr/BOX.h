...
const unsigned int pyramidTriangleIndex[] = {
 ...
 // Definición de la posición de los vértices de la pirámide. Las caras laterales tienen 3 vértices, por lo que al utilizar la estructura del cubo, su tercer y cuarto vértice van a coincidir, repitiéndose la cúspide de la pirámide
...
const float pyramidVertexPos[] = {
	...
	-1.0f, -1.0f,  1.0f, //0
	 1.0f, -1.0f,  1.0f, //1
	 0.0f,  1.0f,  0.0f, //2 (Cúspide)
	 0.0f,  1.0f,  0.0f, //3 (Cúspide)
	...
	-1.0f, -1.0f,  1.0f, //13
	 ...
	 //Cara y = 1 - Esta cara en el cubo sería la superior paralela al suelo. Al tratarse de una pirámide, será su pico más alto y sus 4 vértices se encontrarán en la misma posición
	 0.0f,  1.0f,  0.0f, //16
	 0.0f,  1.0f,  0.0f, //17
	 0.0f,  1.0f,  0.0f, //18
	 0.0f,  1.0f,  0.0f, //19
...
//Normales de los vértices de la pirámide
...
//Colores de los vértices de la pirámide
...
//Tangentes de los vértices de la pirámide
